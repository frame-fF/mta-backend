...
class PlayerData(BaseModel):
    ...
    weapons_in_hand = models.JSONField(default=[[]], blank=True, null=True)
    weapons = models.JSONField(default=[[]], blank=True, null=True)
    ammo = models.JSONField(default=[[]], blank=True, null=True)
    armor = models.FloatField(default=100.00, blank=True, null=True)
    clothes = models.JSONField(default=[[["hoodyAblack", "hoodyA", 0], ["player_face", "head", 1], ["chongergrey", "chonger", 2], ["sneakerbincblk", "sneaker", 3], ["hockey", "hockeymask", 16]]], blank=True, null=True)
